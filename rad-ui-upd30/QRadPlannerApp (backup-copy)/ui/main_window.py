    ...
    def _update_3d_viewer(self):
        ...
        try:
            self.viewer_3d.update_volume(
                ...
                dose_volume_full=self.data_manager.dose_distribution # Pass dose if available
            )
            ...
            if hasattr(self, 'viewer_3d'): self.viewer_3d.clear_view() # Check if viewer_3d exists
